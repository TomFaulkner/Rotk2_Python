...
class Command19(object):
    def __init__(self):
        self.commands = [
            Helper.GetBuiltinText(0x8BFC, 0x8BFF),
            Helper.GetBuiltinText(0x8C05, 0x8C08),
            Helper.GetBuiltinText(0x8C11, 0x8C14),
            Helper.GetBuiltinText(0x8C1D, 0x8C21),
            Helper.GetBuiltinText(0x8C27, 0x8C2A),
            Helper.GetBuiltinText(0x8C30, 0x8C33),
            Helper.GetBuiltinText(0x8C3D, 0x8C40),
            Helper.GetBuiltinText(0x8C46, 0x8C49),
        ]
        self.palette_no = 5
    ...
    def Start(self, province_no):
        while True:
            ...
            if cmd == 1:
                cmds = [
                    Helper.GetBuiltinText(0x8B37, 0x8B3E),
                    Helper.GetBuiltinText(0x8B45, 0x8B4C),
                ]
                Helper.ShowCommandsInInputArea(cmds, cols=2, palette_no=3)

                tmp = Helper.GetInput(
                    Helper.GetBuiltinText(0x8B52) + "(1-2)? ",
                    row=1,
                    required_number_min=1,
                ...
                if tmp == 1:
                    ...
                    img2 = Helper.DrawText(
                        str(int(Data.BUF[0x337D + Data.DATA_OFFSET])), palette_no=1, scaled=True
                    )
                    Helper.Screen.blit(
                        img2,
                        (
                            (300 + int(img.get_width() / Helper.Scale)) * Helper.Scale,
                            295 * Helper.Scale,
                        ),
                    )
                    tmp = Helper.GetInput(
                        Helper.GetBuiltinText(0x8AF8) + "(1-10)? ",
                        cursor_user_prompt_location=True,
                        row=1,
                        required_number_min=1,
                        required_number_max=10,
                    )
                    if tmp > 0:
                    ...
                    Helper.ClearInputArea()
                    options_text = [
                        Helper.GetBuiltinText(0x8ABA),
                        Helper.GetBuiltinText(0x8AC1),
                        Helper.GetBuiltinText(0x8AC6),
                        Helper.GetBuiltinText(0x8ACB),
                    ]
                    ...
                    img2 = Helper.DrawText(
                        "<" + options_text[option] + ">", palette_no=1, scaled=True
                    )
                    Helper.Screen.blit(
                        img2,
                        (
                    ...
                    tmp = Helper.GetInput(
                        Helper.GetBuiltinText(0x8AF8) + "(1-4)? ",
                        cursor_user_prompt_location=True,
                        row=2,
                        required_number_min=1,
            ...
            if cmd == 2:
                ...
                Helper.ClearInputArea()
                img = Helper.DrawText(
                    Helper.GetBuiltinText(0x8A94, 0x8A9B).replace(
                        "%s", Helper.GetBuiltinText(0x8A7A)
                    ),
                    scaled=True,
                )
                Helper.Screen.blit(img, (300 * Helper.Scale, 295 * Helper.Scale))
                ...
                tmp = Helper.GetInput(
                    Helper.GetBuiltinText(0x8AA9) + "(1-2)? ",
                    cursor_user_prompt_location=True,
                    row=1,
                    required_number_min=1,
                    required_number_max=10,
            ...
            if cmd == 3:
                ...
                img = Helper.DrawText(
                    Helper.GetBuiltinText(0x8A94, 0x8A9B).replace(
                        "%s", Helper.GetBuiltinText(0x8A7F)
                    ),
                    scaled=True,
                )
                Helper.Screen.blit(img, (300 * Helper.Scale, 295 * Helper.Scale))
            ...
            if cmd == 4:
                ...
                img = Helper.DrawText(
                    Helper.GetBuiltinText(0x8A94, 0x8A9B).replace(
                        "%s", Helper.GetBuiltinText(0x8A84)
                    ),
                    scaled=True,
                )
                Helper.Screen.blit(img, (300 * Helper.Scale, 295 * Helper.Scale))
            ...
            if cmd == 5:
                ...
                if os.path.exists(Data.GamePath + file_name):
                    Helper.ClearInputArea()
                    yn = Helper.GetInput(
                        Helper.GetBuiltinText(0x6933) + "(Y/N)? ", required_number=False
                    )
                    if yn in [-1, "n"]:
                        continue
            ...
            if cmd == 8:
                Helper.ClearInputArea()
                yn = Helper.GetInput(
                    Helper.GetBuiltinText(0x8A0E, 0x8A19),
                    next_prompt="(Y/N)? ",
                    cursor_user_prompt_location=True,
