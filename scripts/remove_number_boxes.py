...
def remove_number_boxes(image_path: str, output_path: str = None):
    ...
    # Add labels
    cv2.putText(comparison, "Original", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
    cv2.putText(
        comparison, "Cleaned", (width + 20, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2
    )
    ...
    for box in number_boxes:
        ...
        cv2.putText(
            debug_img, str(box["id"]), (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 0, 255), 1
        )
